import os.path
import re
#This python code cannot be attributed directly to me as I didn't make it
#More details about attribution in attributions.md
...
if __name__ == "__main__":
	converter = PythonToPsuedoConverter()
	converter.main()
